...
class Dataset_depth_missing_cricle():

    def __init__(self, dataset_name, amount_of_spots, min_radius, max_radius, DEBUG=False):
    ...
    def delet_random_circle(self, image, min_radius, max_radius):
        """
    ...
    def get_item(self, item_name):
        with Image.open(os.path.join(self.root, item_name+'-depth.png')) as di:
            ...
            for i in range(self.amount_of_spots):
                dpt_um = self.delet_random_circle(dpt_um, self.min_radius, self.max_radius)
