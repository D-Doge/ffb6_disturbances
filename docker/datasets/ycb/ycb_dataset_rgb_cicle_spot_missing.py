...
class Dataset_rgb_circle_spot_missing():
    ...
    def set_random_circle_to_0(self, image, min_radius, max_radius):
        """
    ...
    def get_item(self, item_name):
        ...
        with Image.open(os.path.join(self.root, item_name+'-color.jpg')) as ri:
            ...
            for i in range(self.amount_of_spots):
                rgb = self.set_random_circle_to_0(rgb, self.min_radius, self.max_radius)
