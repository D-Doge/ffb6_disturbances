...
from datasets.ycb.ycb_dataset_no_noise import Dataset_no_noise
from datasets.ycb.train_ycb_dataset_depth_cirlce_spot_missing import Dataset_depth_missing_cricle_train
from torch.utils.data import DataLoader
import numpy as np
...
epoche = 0
iteration = 0
model_name = "depth_cirlce_missing"
modelLoadPath = ""
...
#Init Datasets 
train_data_set = Dataset_depth_missing_cricle_train('train')
...
train_dataloader = DataLoader(train_data_set, batch_size=16, shuffle=True, drop_last=False, num_workers=4)
